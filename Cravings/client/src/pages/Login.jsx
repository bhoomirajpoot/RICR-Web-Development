              ...
              <div className="mb-5">
                <div className="space-y-4">
                  <input
                    ...
                    required
                    disabled={isLoading}
                    className="w-full h-fit px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-pink-500 transition disabled:cursor-not-allowed disabled:bg-gray-200"
                  />
                  ...
                  <input
                    ...
                    required
                    disabled={isLoading}
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-pink-500 transition disabled:cursor-not-allowed disabled:bg-gray-200"
                  />
                </div>
